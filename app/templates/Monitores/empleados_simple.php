 ...
 <!-- <form action="index.php?ctl=guardar_monitor" method="post">-->
  ...
  <div style="float:center">
    <table border="1" width="1979px" style="margin-left: 40px; margin-right: 40px;">
        <tr>
        ...
        <tr>
         ...
         <tr><!--encabezados-->
            ...
            <!--<th width="96px" class="centrados encabezados_gris">&nbsp;&nbsp;&nbsp;Bono</th>-->
            <th width="96px" class="centrados encabezados_gris">&nbsp;&nbsp;&nbsp;Sueldo Semanal Neto</th>
            <th width="96px" class="centrados encabezados_gris">&nbsp;&nbsp;&nbsp;Descuento</th>
            ...
            if($cuenta['num_cuenta']== $empleado['cta_contable']){?>
                <form action="index.php?ctl=guardar_historicos" name="form0" method="post" > 
                    <tr>
                        ...
                        <!--<td width="96px" class="derecha">&nbsp;&nbsp;&nbsp;<?php echo number_format($empleado['bono'],2,".",",")  ?></td>-->
                        ...
                        <td width="96px" class="derecha"><input  type="number" min="0" step="0.01" class="derecha cantidades" id="fiscal_<?php echo $cuenta['num_cuenta_alt'] ?>_<?php echo $empleado['empleado_id']?>" name="fiscal" value="<?php echo $empleado['su_sem_fiscal'] ?>" ></td>
                        <td width="96px" class="derecha"><input  type="text" min="0" step="0.01" class="derecha cantidades" id="sueldo_efectivo_<?php echo $cuenta['num_cuenta_alt'] ?>_<?php echo $empleado['empleado_id']?>"  name="sueldo_efectivo" value="<?php echo $empleado['su_sem_efectivo'] ?>" readonly ></td>
                         <!--datos a mostrar-->
                    </tr>
                </form>
             <?php 
